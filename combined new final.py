...
label_scale = 1.0  # Smaller font scale
label_thickness = 2  # Smaller font thickness
...
while True:
    ...
    cv2.putText(combined_frame, 'Original', (30, 40), label_font, label_scale, label_color, label_thickness)
    cv2.putText(combined_frame, 'Grayscale', (frame_width + 30, 40), label_font, label_scale, label_color, label_thickness)
    cv2.putText(combined_frame, 'Enhanced', (30, frame_height + 40), label_font, label_scale, label_color, label_thickness)
    cv2.putText(combined_frame, 'Original with Face Detection', (frame_width + 30, frame_height + 40), label_font, label_scale, label_color, label_thickness)
