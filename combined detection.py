...
while True:
    ...
    for current_frame in [original_frame, gray_frame, enhanced_frame, gray_enhanced_frame]:
        faces = face_cascade.detectMultiScale(current_frame, scaleFactor=1.1, minNeighbors=5, minSize=(30, 30))
